...
/// <summary>
/// MVC-контроллер: управляет потоком данных между View и моделью.
/// </summary>
public class BookController
{
    ...
    public void OnAdd()
    {
        ...
        RefreshData();
        _view.ClearInput();
        _view.ShowInfo($"Книга добавлена с ID {created.ID}.");
    }
    ...
    public void OnUpdate()
    {
        ...
        {
            _view.ShowError("Сначала выберите книгу и заполните поля.");
            return;
        }
    ...
    public void OnDelete()
    {
        ...
        {
            _view.ShowError("Сначала выберите книгу.");
            return;
        }
